                ...
                userEmpty ?
                    ...
                    (<DropdownMenuItem option={<UilUser/>} className=' hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600'>
                        <div className=' shadow-2xl	 bg-white'>
                            <div className="divide-y divide-slate-200  py-1 text-sm text-gray-700 dark:text-gray-400 text-center" aria-labelledby="dropdownNavbarButton">
                                ...
                                <p className="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Log Out</p>
                            </div>
                        </div>
                    </DropdownMenuItem>)
