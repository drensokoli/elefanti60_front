                ...
                <div className='w-1/2 h-auto invisible sm:visible'>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div class="relative">
                            ...
                            <input type="search" name="searchTerm" id="default-search" value={searchTerm} onChange={handleInput}class="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-30 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black" placeholder="Kerko produkte" required="" />
